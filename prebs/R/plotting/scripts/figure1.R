...
pdf(output_absolute, height=MY_HEIGHT, width=MY_WIDTH)
old.par <- par
...
pdf(output_diff, height=MY_HEIGHT, width=MY_WIDTH)
old.par <- par
par(mfrow=c(2,3), mar=c(5, 4, 1, 1) + 0.1)
...
pdf(output_stock, height=MY_HEIGHT2, width=MY_WIDTH2)
old.par <- par
...
pdf(output_venn, width=5.5, height=2.75)

pushViewport(viewport(layout = grid.layout(1, 2)))

pushViewport(viewport(layout.pos.col = 1, layout.pos.row = 1))
load(paste(Marioni_dir, "/venn.RData", sep=""))
venn.plot1 <- draw.triple.venn(area1, area2, area3, n12, n23, n13, n123, category = c("MMSEQ", "Microarray", "PREBS"), fill = c("green", "red", "blue"), cat.col = c("green", "red", "blue"), lty = "blank", cex = 0.6, cat.cex = 0.6, euler.d=TRUE, scaled=TRUE, margin=0.05);
...
venn.plot2 <- draw.triple.venn(area1, area2, area3, n12, n23, n13, n123, category = c("MMSEQ", "Microarray", "PREBS"),  fill = c("green", "red", "blue"), cat.col = c("green", "red", "blue"), lty = "blank", cex = 0.6, cat.cex = 0.6, euler.d=TRUE, scaled=TRUE, margin=0.05, title="LAML data" );
