...
no_filter <- data[ is.element(data$Gene_ID, var_data$Gene_ID), ]

rna_id05 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.95) , ]
rna_id10 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.90) , ]
rna_id20 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.80) , ]
rna_id30 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.70) , ]
rna_id40 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.60) , ]
rna_id50 <- var_data[ var_data$rna_exp_var < quantile(var_data$rna_exp_var,0.50) , ]

array_id05 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.95) , ]
array_id10 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.90) , ]
array_id20 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.80) , ]
array_id30 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.70) , ]
array_id40 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.60) , ]
array_id50 <- var_data[ var_data$array_exp_var < quantile(var_data$array_exp_var,0.50) , ]
...
write.table(no_filter, file=paste(input_file, ".nofilter", sep=""), quote = FALSE, sep = " ")
