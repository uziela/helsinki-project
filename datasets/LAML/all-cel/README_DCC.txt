README for archive genome.wustl.edu_LAML.HG-U133_Plus_2.Level_1.1.2.0

This file was automatically generated on 01/25/2011 using the TCGA DCC Archive Processing System.
...
with Acute Myeloid Leukemia. The data was produced by the Washington University School of Medicine
(genome.wustl.edu) Cancer Genomic Characterization Center (CGCC) using the Affymetrix Human Genome
U133 Plus 2.0 Array platform.

This archive is the 2nd revision of the 1st archive and contains only Level 1 (raw) data.
